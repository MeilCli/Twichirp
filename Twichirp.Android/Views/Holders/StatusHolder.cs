...
namespace Twichirp.Android.Views.Holders {
    ...
    public class StatusHolder : BaseHolder<BaseViewModel>, IStatusView {
        ...
        public static StatusHolder Make(IView view, ViewGroup parent) {
            var itemView = InflateView(view, Resource.Layout.constraint_status_holder, parent);
        ...
        public int MediaContainerId { get; protected set; }

        public AView MediaFrame1 { get; protected set; }

        public AView MediaFrame2 { get; protected set; }

        public AView MediaFrame3 { get; protected set; }

        public AView MediaFrame4 { get; protected set; }
        ...
        public AView ReplyIconClickable { get; private set; }

        public ImageView ReplyIcon { get; private set; }

        public AView RetweetIconClickable { get; private set; }

        public ImageView RetweetIcon { get; private set; }

        public TextView RetweetCount { get; private set; }

        public AView FavoriteIconClickable { get; private set; }
        ...
        public int QuotingMediaContainerId { get; protected set; }
        ...
        protected StatusHolder(AView itemView, IView view, int statusType = StatusViewModel.NormalTweet)
            ...
            MediaContainerId = Resource.Id.MediaContainer;
            QuotingMediaContainerId = Resource.Id.QuotingMediaContainer;
        }
        ...
        public override void OnCreatedView() {
            ...
            ReplyIconClickable = ItemView.FindViewById<AView>(Resource.Id.ReplyIconClickable);
            ReplyIcon = ItemView.FindViewById<ImageView>(Resource.Id.ReplyIcon);
            RetweetIconClickable = ItemView.FindViewById<AView>(Resource.Id.RetweetIconClickable);
            ...
            FavoriteIconClickable = ItemView.FindViewById<AView>(Resource.Id.FavoriteIconClickable);
    ...
    public class StatusMediaHolder : StatusHolder {
        ...
        public new static StatusMediaHolder Make(IView view, ViewGroup parent) {
            var itemView = InflateView(view, Resource.Layout.constraint_status_media_holder, parent);
        ...
        public override void OnCreatedView() {
            base.OnCreatedView();
            MediaFrame1 = ItemView.FindViewById<AView>(Resource.Id.MediaFrame1);
            MediaFrame2 = ItemView.FindViewById<AView>(Resource.Id.MediaFrame2);
            MediaFrame3 = ItemView.FindViewById<AView>(Resource.Id.MediaFrame3);
            MediaFrame4 = ItemView.FindViewById<AView>(Resource.Id.MediaFrame4);
    ...
    public class StatusQuotingHolder : StatusHolder {
        ...
        public new static StatusQuotingHolder Make(IView view, ViewGroup parent) {
            var itemView = InflateView(view, Resource.Layout.constraint_status_quoting_holder, parent);
    ...
    public class StatusQuotingInnerMediaHolder : StatusHolder {
        ...
        public new static StatusQuotingInnerMediaHolder Make(IView view, ViewGroup parent) {
            var itemView = InflateView(view, Resource.Layout.constraint_status_quoting_inner_media_holder, parent);
    ...
    public class StatusQuotingOuterMediaHolder : StatusHolder {
        ...
        public new static StatusQuotingOuterMediaHolder Make(IView view, ViewGroup parent) {
            var itemView = InflateView(view, Resource.Layout.constraint_status_quoting_outer_media_holder, parent);
    ...
    public class StatusQuotingInnerAndOuterMediaHolder : StatusHolder {
        ...
        public new static StatusQuotingInnerAndOuterMediaHolder Make(IView view, ViewGroup parent) {
            var itemView = InflateView(view, Resource.Layout.constraint_status_quoting_inner_and_outer_media_holder, parent);
